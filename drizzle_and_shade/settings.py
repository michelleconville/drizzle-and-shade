"""
Django settings for drizzle_and_shade project.
...
WSGI_APPLICATION = 'drizzle_and_shade.wsgi.application'
...
if 'USE_AWS' in os.environ:
    ...
    # Bucket Config
    AWS_STORAGE_BUCKET_NAME = 'drizzleandshade'
...
if 'DEVELOPMENT' in os.environ:
    ...
    DEFAULT_FROM_EMAIL = 'drizzleandshade@example.com'
else:
